...
return [
    'custom' => [
        ...
        'navbarBgColor' => 'purple darken-4', //Options: cyan,teal,light-blue,amber (any of materializecolor class can be pass). warning:if isNavbarDark set NavbarBgColor not work.
        ...
        'activeMenuColor' => 'purple darken-4', //Sidebar active menu color (any of materializecolor class can be pass)
        ...
        'templateTitle' => 'Social', //template Title can be changes default('Materialize)
