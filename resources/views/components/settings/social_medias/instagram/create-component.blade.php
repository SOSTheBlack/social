            ...
            <div class="col s12">
                <div class="card">
                    <div class="card-content">
                        ...
                        <ul class="stepper horizontal linear" id="linearStepper">
                                ...
                                <div class="step-content">
                                    <div class="row">
                                        <div class="input-field col m6 s12">
                                            ...
                                            <input type="text" id="firstName12" name="firstName1" class="validate"
                                                   required>
                                        </div>
                                        <div class="input-field col m6 s12">
                                            <label for="lastName1">Last Name: <span class="red-text">*</span></label>
                                            <input type="text" id="lastName1" class="validate" name="lastName1"
                                                   required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="input-field col m6 s12">
                                            <label for="contactNum2">Contact Number: <span
                                                        class="red-text">*</span></label>
                                            <input type="number" class="validate" name="contactNum" id="contactNum2"
                                                   required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="input-field col m6 s12">
                                            <label for="proposal1">Proposal Title: <span
                                                        class="red-text">*</span></label>
                                            <input type="text" class="validate" id="proposal1" name="proposal1"
                                                   required>
                                        </div>
                                        <div class="input-field col m6 s12">
                                ...
                                <div class="step-content">
                                    <div class="row">
                                        <div class="input-field col m6 s12">
                                            ...
                                            <input type="text" class="validate" id="eventName1" name="eventName1"
                                                   required>
                                        </div>
                                        <div class="input-field col m6 s12">
                                            <select>
