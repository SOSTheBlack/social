        ...
        <div class="container">
            <div class="row">
                <div class="col s10 m6 l6">
                    <h5 class="breadcrumbs-title mt-0 mb-0"><span>@yield('title', $title ?? '') </span></h5>
            ...
            <div class="row">
                <div class="col s10 m6 l6 breadcrumbs-left">
                    <h5 class="breadcrumbs-title mt-0 mb-0 display-inline hide-on-small-and-down">
                        <span>@yield('title', $title ?? '')</span></h5>
                    @if(isset($breadcrumbs))
                        <ol class="breadcrumbs mb-0">
                            @foreach ($breadcrumbs as $breadcrumb)
                                <li class="breadcrumb-item {{ !isset($breadcrumb['link']) ? 'active' :''}}">
...
@elseif($configData['mainLayoutType'] === 'horizontal-menu')
    ...
    <div class="pt-1 pb-0" id="breadcrumbs-wrapper">
        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m6 l6">
                    <h5 class="breadcrumbs-title"><span>@yield('title', $title ?? '') </span></h5>
                </div>
                <div class="col s12 m6 l6 right-align-md">
                    @if(isset($breadcrumbs))
                        <ol class="breadcrumbs mb-0">
